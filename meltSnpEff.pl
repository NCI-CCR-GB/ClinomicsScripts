...
# 
# caller --> order samples in vcf file --> snpEff --> formatInput --> meltSnpEff --`
#                                                                                    `
# caller --> order samples in vcf file --> snpEff --> formatInput --> meltSnpEff =====`>> Join Calls --> Annotation --> (extract columns of your interest)--> Filtering.
#                                                                                    `
# caller --> order samples in vcf file --> snpEff --> formatInput --> meltSnpEff --`
